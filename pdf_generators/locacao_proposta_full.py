...
def get_custom_styles():
    ...
    styles.add(ParagraphStyle(name='NormalText',
                             ...
                             alignment=TA_LEFT,
                             spaceAfter=6))
    styles.add(ParagraphStyle(name='NormalTextIndent',
                             fontName='Helvetica',
                             fontSize=10,
                             alignment=TA_LEFT,
                             firstLineIndent=18, # Indentação para itens de lista
                             leftIndent=18,
                             spaceAfter=6))
    ...
    styles.add(ParagraphStyle(name='TableContent',
                             ...
                             alignment=TA_LEFT,
                             spaceAfter=2))
    styles.add(ParagraphStyle(name='SignatureLine',
                             fontName='Helvetica',
                             fontSize=10,
                             alignment=TA_CENTER,
                             spaceAfter=0))
    styles.add(ParagraphStyle(name='SignatureLabel',
                             fontName='Helvetica-Bold',
                             fontSize=10,
                             alignment=TA_LEFT,
                             spaceAfter=6))
    styles.add(ParagraphStyle(name='SignatureLabelCenter',
                             fontName='Helvetica-Bold',
                             fontSize=10,
                             alignment=TA_CENTER,
                             spaceAfter=6))
...
def add_page_1_content(story, styles):
    """Adiciona o conteúdo da página 1."""
    ...
    story.append(Paragraph("NÚMERO: _________ DATA: _________", styles['NormalText']))
    story.append(Spacer(1, 0.1 * inch))

    story.append(Paragraph("Cliente: ________________________", styles['NormalText']))
    story.append(Paragraph("A/C : ________________________", styles['NormalText']))
    story.append(Paragraph("Data: ________________________", styles['NormalText']))
    story.append(Spacer(1, 0.1 * inch))

    story.append(Paragraph("De: GRUPO DELGA", styles['NormalText']))
    story.append(Paragraph("WORLD COMP DO BRASIL", styles['NormalText']))
    story.append(Paragraph("Srta Rogério Cerqueira | Valdir Bernardes", styles['NormalText']))
    story.append(Paragraph("Compras", styles['NormalText']))
    story.append(Paragraph("rogerio@worldcompressores.com.br", styles['NormalText']))
    story.append(Paragraph("11 97283-8255", styles['NormalText']))
    story.append(Paragraph("valdir@worldcompressores.com.br", styles['NormalText']))
    story.append(Paragraph("Aline.gomes@delga.com.br", styles['NormalText']))
...
def add_page_2_content(story, styles):
    """Adiciona o conteúdo da página 2."""
    ...
    data_diadema = [
        [Paragraph("Item", styles['TableHeading']), Paragraph("Qtd.", styles['TableHeading']), Paragraph("Descrição", styles['TableHeading']), Paragraph("Valor unitário", styles['TableHeading']), Paragraph("Periodo", styles['TableHeading'])],
...
def add_page_3_content(story, styles):
    """Adiciona o conteúdo da página 3."""
    story.append(PageBreak())
    ...
    for item in commercial_conditions:
        story.append(Paragraph(f"• {item}", styles['NormalTextIndent']))
    story.append(Spacer(1, 0.3 * inch))


def add_page_4_content(story, styles):
    """Adiciona o conteúdo da página 4."""
    story.append(PageBreak())
...
def create_full_proposal_pdf(output_filename="proposta_comercial_completa.pdf"):
    """Cria o PDF completo com todas as páginas."""
    doc = SimpleDocTemplate(output_filename, pagesize=A4)
    styles = get_custom_styles()
    story = []

    # Adicionar conteúdo de cada "página" lógica
    add_page_1_content(story, styles)
    add_page_2_content(story, styles)
    add_page_3_content(story, styles)
    add_page_4_content(story, styles)
