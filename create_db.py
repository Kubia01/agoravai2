...
def criar_banco():
    ...
    print("✅ Tabela itens_cotacao criada")
    ...
    print("✅ Tabela relatorios_tecnicos criada")
    ...
    print("✅ Tabela permissoes_usuarios criada")
    ...
    print("✅ Tabela eventos_campo criada")
